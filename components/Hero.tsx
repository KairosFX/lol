...
export function Hero({ championCount, dataVersion, featuredChampions }: HeroProps) {
      ...
      <div className="rift-shell grid min-h-[calc(100vh-4rem)] items-center gap-10 py-12 lg:grid-cols-[1.05fr_0.95fr] lg:py-16">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Browse all champions through a static, searchable library built from Riot Data Dragon
            and League Wiki records. Filter by role, class, region, difficulty, release date, and
            build intelligence.
          </p>
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-3">
            <div className="rounded-lg border border-white/10 bg-white/[0.06] p-4 backdrop-blur-md">
              ...
              <p className="mt-1 text-sm text-slate-400">Champions validated</p>
            </div>
            <div className="rounded-lg border border-white/10 bg-white/[0.06] p-4 backdrop-blur-md">
              <Database aria-hidden="true" className="text-brightgold" size={24} />
              <p className="mt-3 text-sm font-semibold text-white">Data Dragon {dataVersion}</p>
              <p className="mt-1 text-xs text-slate-500">Static JSON export</p>
            </div>
            <div className="rounded-lg border border-white/10 bg-white/[0.06] p-4 backdrop-blur-md">
              <ShieldCheck aria-hidden="true" className="text-arcane" size={24} />
              <p className="mt-3 text-sm font-semibold text-white">No duplicates</p>
              <p className="mt-1 text-xs text-slate-500">Hard validation at sync time</p>
            </div>
          </div>
        </div>
        ...
        <div className="glass-panel gold-stroke rounded-lg p-4 lg:p-5">
          <div className="mb-4 flex items-center justify-between gap-4">
            <div>
              <h2 className="text-lg font-bold text-white">Recent Releases</h2>
              <p className="mt-1 text-sm text-slate-400">Newest champions from the data sync</p>
            </div>
